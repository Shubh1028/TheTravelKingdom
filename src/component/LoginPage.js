...
onSubmit = e => {
 ...
 //-------------->>>>>>>>>> HANDLE CHANGE FUNCTION <<<<<<<<<---------------//
  ...
  render() {
    ...
    return (
      <div style={{paddingTop: "100px", height: "65vh", paddingBottom:"440px"}} className="container-main">
        <Card
          elevation="10"
        ...
        >
           <h1><span style={{marginLeft:"113px" , color: "blue"}}>Login</span></h1>
          <br/>
          ...
          <text style={{marginLeft:window.screen.width>540?'15%':'7%', fontSize:20}}>
