...
export class PackageForm extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      this.state.package_image !== prevState.package_image &&
      this.state.package_image !== null &&
      this.state.package_image !== undefined
    ) {
      this.setState({
        imageShow: URL.createObjectURL(this.state.package_image),
      });
    }
  }
        ...
        <form onSubmit={(e) => this.onSubmit(e)}>
          ...
          >
            <h1>
              <span
                style={{
                  marginLeft: window.screen.width > 500 ? "170px" : "0px",
                  color: "blue",
                }}
              >
                Package Form
