...
export class HomePage extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      this.props.destinationListData !== prevProps.destinationListData &&
      this.props.destinationListData !== undefined &&
      this.props.destinationListData !== null
    ) {
  ...
  render() {
    ...
    return (
      <div
        style={{ backgroundColor: "#ebf2f2", position: "relative" }}
      ...
      >
        ...
        >
          ...
          <div style={{ maxHeight: 250, overflowY: "auto" }}>
            {this.state.search &&
              this.state.destinationListData &&
              this.state.destinationListData.map((data) => (
        ...
        >
          ...
          >
            ...
            <Card.ImgOverlay>
              ...
              <Card.Text style={{ textAlign: "center" }}>Baga Beach</Card.Text>
            </Card.ImgOverlay>
          </Card>
          ...
          >
            ...
            <Card.ImgOverlay>
              ...
              <Card.Text style={{ textAlign: "center" }}>Red Fort</Card.Text>
            </Card.ImgOverlay>
          </Card>
          ...
          >
            ...
            <Card.ImgOverlay>
              ...
              <Card.Text style={{ textAlign: "center" }}>Taj Mahal</Card.Text>
            </Card.ImgOverlay>
          </Card>
        ...
        >
          ...
          >
            ...
            <Card.ImgOverlay>
              ...
              <Card.Text style={{ textAlign: "center" }}>Romantic</Card.Text>
            </Card.ImgOverlay>
          </Card>
          ...
          >
            ...
            <Card.ImgOverlay>
              ...
              <Card.Text style={{ textAlign: "center" }}>Monumental</Card.Text>
            </Card.ImgOverlay>
          </Card>
          ...
          >
            ...
            <Card.ImgOverlay>
              ...
              <Card.Text style={{ textAlign: "center" }}>Historic</Card.Text>
            </Card.ImgOverlay>
          </Card>
          ...
          >
            ...
            <Card.ImgOverlay>
              ...
              <Card.Text style={{ textAlign: "center" }}>Adventure</Card.Text>
            </Card.ImgOverlay>
          </Card>
        </div>
      </div>
