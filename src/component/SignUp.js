  ...
  render() {
    ...
    return (
      <div style={{paddingTop: "101px", paddingBottom: "50px"}} className="container-main">
        ...
        >
          <h1><span style={{marginLeft: window.screen.width > 540 ? "35%":"0px" , color: "blue"}}>Sign Up</span></h1>
          <br/>
          <div
            style={{
              display: "flex",
          ...
          >
            <div>
              <text style={{ fontSize: "20px", color: "blue" }}>Age Range</text>
              <br />
              <select
                className="form-control"
                name="age_range"
              ...
              <div>
                <text style={{ color: "red" }}>{this.state.age_rangeError}</text>
              </div>
            </div>
            <div>
              <text style={{ fontSize: "20px", color: "blue" }}>
          ...
          >
            <div>
              ...
              >
                {/* <option value="">None</option> */}
                <option value="1">Which Is Your Favourite Destination ?</option>
                <option value="2">What Is Your Home Town ? </option>
                <option value="3">What Is Your Nationality</option>
              </select>
              <div>
                <text style={{ color: "red" }}>{this.state.security_questionError}</text>
              </div>
            </div>
            <div>
              <text style={{ fontSize: "20px", color: "blue" }}>Add Your Answer Here</text>
              <br/>
              <input
                size="lg"
                type="text"
              ...
              />
              <div>
                <text style={{ color: "red" }}>{this.state.security_answerError}</text>
              </div>
            </div>
          </div>
          ...
          <text style={{marginLeft:window.screen.width>540?'30%':'', fontSize:20}}>
