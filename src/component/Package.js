...
export class Package extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (
      ...
      this.props.packageData !== undefined &&
      this.props.packageData !== null
    ) {
      this.setState({
      ...
      <div style={{ paddingTop: "70px" }}>
        ...
        >
          {this.state.packageData &&
            this.state.packageData.map((data) => (
              <Card
                className="card-of-package"
                elevation="5"
                ...
                <div style={{ marginLeft: "8px", marginTop: "8px" }}>
                  <div style={{ display: "flex" }}>
                    ...
                    <h4 style={{ marginLeft: "5px", color: "black" }}>
                      {data.package_name}, {data.package_location}
                    </h4>
                  </div>
                  <StyledRating
                  ...
                  <h5 style={{ fontWeight: "bold" }}>
                    ...
                    >
                      <strike style={{ color: "red", marginRight: "10px" }}>
                        {" "}
                        &#x20b9; {data.price}
                      </strike>
                      &#x20b9; {data.offer_price}{" "}
