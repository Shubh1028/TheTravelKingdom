...
export class UserProfile extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (
      this.props.userProfileData !== prevProps.userProfileData &&
      this.props.userProfileData !== undefined &&
    ...
    return (
      ...
      >
        {this.state.userProfileData &&
          this.state.userProfileData.map((data) => (
            <Card
              elevation="10"
            ...
            >
              <Avatar
                ...
                style={{
                  height: "170px",
                  width: "170px",
                  marginLeft: window.screen.width > 540 ? "33%" : "25%",
                }}
              />
