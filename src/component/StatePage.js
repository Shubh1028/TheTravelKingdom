      ...
      <div style={{ paddingTop: "70px" }}>
        ...
        >
          ...
          >
            ...
            <div style={{ marginLeft: "8px", marginTop: "8px" }}>
              <div style={{ display: "flex" }}>
                ...
                <h4 style={{ marginLeft: "5px", color: "black" }}>
              ...
              <h5 style={{ fontWeight: "bold" }}>
                ...
                <span style={{ fontSize: "18px", fontWeight: "lighter" }}>
                  Dal Lake, Nishat Bagh, Chashemi Shahi
                </span>
              </h5>
              <Button
                style={{
          ...
          >
            <img
              height="270px"
              src="https://akm-img-a-in.tosshub.com/indiatoday/images/story/201509/f-tamil-1_647_091715023748.jpg"
              alt="Image2"
            ></img>
            <div style={{ marginLeft: "8px", marginTop: "8px" }}>
              <div style={{ display: "flex" }}>
              ...
              <h5 style={{ fontWeight: "bold" }}>
                Famous Places :{" "}
                <span style={{ fontSize: "18px", fontWeight: "lighter" }}>
                  Nilgiri Mountain Railway Ooty Lake Emerald Lake
                </span>
              </h5>
              <Button
                style={{
          ...
          >
            <img
              height="270px"
              src="https://amp.thenationalnews.com/image/policy:1.156949:1499293771/image/jpeg.jpg?f=16x9&w=1200&$p$f$w=dfa40e8"
              alt="Image3"
            ></img>
            <div style={{ marginLeft: "8px", marginTop: "8px" }}>
              <div style={{ display: "flex" }}>
              ...
              <h5 style={{ fontWeight: "bold" }}>
                ...
                <span style={{ fontSize: "18px", fontWeight: "lighter" }}>
                  {" "}
                  Nathula Pass MG Road, Gangtok Rumtek Monastery
                </span>
              </h5>
              <Button
                style={{
          ...
          >
            <img
              height="270px"
              src="https://www.holidify.com/images/cmsuploads/compressed/3617_20190213162441jpg"
              alt="Image4"
            ></img>
            <div style={{ marginLeft: "8px", marginTop: "8px" }}>
              <div style={{ display: "flex" }}>
